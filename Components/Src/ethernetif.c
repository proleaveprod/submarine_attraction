...
/* Ethernet pins configuration ************************************************/
  /*
        ...
        RMII_MII_RXD0 ---------------------> PC4
        RMII_MII_RXD1 ---------------------> PC5
        RMII_MII_RXER ---------------------> PG2        В PI11
        RMII_MII_TX_EN --------------------> PG11
        RMII_MII_TXD0 ---------------------> PG13
        RMII_MII_TXD1 ---------------------> PB13
  */

  // ______________________________________________ВЫСТРАИВАЕМ КОНФИГУРАЦИЮ ПО ПЛАТЕ СТВЦ. 
...
//  // Configure PB13                             ВМЕСТО PB13 PG13
...
//  HAL_GPIO_Init(GPIOB, &GPIO_InitStructure);
  ...
  GPIO_InitStructure.Pin =  GPIO_PIN_11 | GPIO_PIN_13 | GPIO_PIN_12;  // + PG12 и - PG2(rxer)
  HAL_GPIO_Init(GPIOG, &GPIO_InitStructure);	
  
  GPIO_InitStructure.Pin =  GPIO_PIN_10;											// + PI10 (rxer)
