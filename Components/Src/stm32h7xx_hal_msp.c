...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
	...
	__HAL_RCC_GPIOF_CLK_ENABLE(); 	// Добавлен для второго uart7
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE7     ------> UART7_RX
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_9|GPIO_PIN_8|GPIO_PIN_7);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA12     ------> USART1_DE
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_10|GPIO_PIN_9|GPIO_PIN_12);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_6);
